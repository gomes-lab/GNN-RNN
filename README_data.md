...
This dataset contains crop yield, weather, soil, and crop progress information for US counties in 1981-2020. Specifically, each row contains data for a unique county and year. There are two versions: one contains weather data for each week (averaged),
and one contains weather data for each day.
